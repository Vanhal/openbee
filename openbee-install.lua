...
local files = {
  {
    ...
    url = "https://raw.github.com/clienthax/openbee/"..branch.."/openbee-install.lua"
  },
  {
    name = "openbee",
    url = "https://raw.github.com/clienthax/openbee/"..branch.."/openbee.lua"
  },
  {
    name = "matron",
    url = "https://raw.github.com/clienthax/openbee/"..branch.."/matron.lua"
  }
}
